...
#min(len(str1), len(str2)) < Gives me the right numbers (almost - the 8th column and 6th row
...
#print("The final matrix with edit distance at the bottom right")
#for x in matrix:
#	print(*x)
#print(editDist, "Edit distance")
			
#for x in auxilaryMatrix:
#	print(*x) 
#TO CHECK AUX MATRIX


#reversed(range(1, columns)
